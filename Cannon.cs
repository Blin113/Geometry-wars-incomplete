...
namespace Template
{
    class Cannon : BaseEnemy
    {
        ...
        public Cannon(Texture2D texture, Vector2 texturePos, float angle) : base(texture, texturePos, angle)
        {
        ...
        public override void Update(Camera camera)
        {
            ...
            if (rnd.Next(0, 100) <= 1)
            {
                weaponHandler.Shoot(texturePos, angle, new Vector2(), new Point(), Player.CurrentPlayerPos, DamageOrigin.enemy, trigger);
            }
